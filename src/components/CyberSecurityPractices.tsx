      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-6 md:space-y-8">
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-gray-950">
          ...
          <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] rounded-xl overflow-hidden">
            <img
              ...
              className="w-full h-full object-cover rounded-xl animate-fade-in animation-delay-200"
            />
          </div>
        </div>
      </div>
