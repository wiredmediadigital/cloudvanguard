...
const trustedCompanies = [
  { name: "TechStart Solutions", logo: "/logos/techstart.svg" },
  { name: "Global Innovations", logo: "/logos/global-innovations.svg" },
  { name: "DataFlex Systems", logo: "/logos/dataflex.svg" },
  { name: "SecureNet", logo: "/logos/securenet.svg" },
  { name: "CloudBase", logo: "/logos/cloudbase.svg" },
  { name: "Digital Frontier", logo: "/logos/digital-frontier.svg" }
];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center">
            {trustedCompanies.map((company, index) => (
              <div
                key={index}
                className="flex items-center justify-center p-4 glass rounded-lg animate-fade-in h-20"
